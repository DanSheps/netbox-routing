...
from netbox_routing.constants.bgp import BGPPEERAF_ASSIGNMENT_MODELS
...
class BGPRouterSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        model = BGPRouter
        fields = ('url', 'id', 'display', 'device', 'asn', 'settings', 'tenant', 'description', 'comments',)
...
class BGPScopeSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        model = BGPScope
        fields = ('url', 'id', 'display', 'router', 'vrf', 'settings', 'tenant', 'description', 'comments',)
...
class BGPSessionTemplateSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'url', 'id', 'display', 'name', 'router', 'parent', 'enabled', 'asn', 'bfd', 'password',
            'tenant', 'description', 'comments',
        )
        brief_fields = ('url', 'id', 'display', 'name', 'router', 'parent', )
...
class BGPPolicyTemplateSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        model = BGPSessionTemplate
        fields = (
            'url', 'id', 'display', 'name', 'router', 'enabled',
            'prefixlist_in', 'prefixlist_out', 'routemap_in', 'routemap_out',
            'tenant', 'description', 'comments',
        )
        brief_fields = ('url', 'id', 'display', 'name', 'router', )
...
class BGPAddressFamilySerializer(NetBoxModelSerializer):
    ...
    class Meta:
        ...
        fields = ('url', 'id', 'display', 'scope', 'address_family', 'settings', 'tenant', 'description', 'comments',)
...
class BGPPeerTemplateSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'url', 'id', 'display', 'name', 'remote_as', 'enabled', 'tenant', 'description', 'comments',
        )
        brief_fields = ('url', 'id', 'display', 'name', 'remote_as', )
...
class BGPPeerSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        model = BGPPeer
        fields = (
            'url', 'id', 'display', 'scope', 'peer', 'remote_as', 'local_as', 'enabled', 'bfd', 'password',
            'tenant', 'description', 'comments',
        )
...
class BGPPeerAddressFamilySerializer(NetBoxModelSerializer):
    ...
    class Meta:
        model = BGPPeer
        fields = (
            'url', 'id', 'display', 'assigned_object_type', 'assigned_object_id', 'assigned_object', 'address_family',
            'enabled', 'peer_policy', 'prefixlist_in', 'prefixlist_out', 'routemap_in', 'routemap_out',
            'tenant', 'description', 'comments',
        )
        brief_fields = ('url', 'id', 'display', 'scope', 'peer', 'remote_as', 'enabled')
