...
routers = PluginMenuItem(
    ...
    buttons=(
        PluginMenuButton(
            'plugins:netbox_routing:eigrprouter_add',
            'Add',
            'mdi mdi-plus',
...
address_families = PluginMenuItem(
    ...
    buttons=(
        ...
        PluginMenuButton(
            'plugins:netbox_routing:eigrpaddressfamily_import',
            'Import',
            'mdi mdi-upload',
            ButtonColorChoices.CYAN,
        ),
...
networks = PluginMenuItem(
    ...
    buttons=(
        ...
        PluginMenuButton(
            'plugins:netbox_routing:eigrpnetwork_import',
            'Import',
            'mdi mdi-upload',
            ButtonColorChoices.CYAN,
        ),
...
interfaces = PluginMenuItem(
    ...
    buttons=(
        ...
        PluginMenuButton(
            'plugins:netbox_routing:eigrpinterface_import',
            'Import',
            'mdi mdi-upload',
            ButtonColorChoices.CYAN,
        ),
