    ...
    def setUpTestData(cls):
        cls.patterns = sorted(
            [
                ...
                'routingprefixlist_list',
                'routingprefixlist_add',
                # 'routingprefixlist_bulk_import',
                'routingprefixlist',
                'routingprefixlist_edit',
                'routingprefixlist_entries',
                'routingprefixlist_delete',
                'routingprefixlist_changelog',
                'routingprefixlist_journal',
                'routingprefixlistentry_list',
                'routingprefixlistentry_add',
                'routingprefixlistentry_bulk_edit',
                'routingprefixlistentry_bulk_delete',
                # 'routingprefixlistentry_bulk_import',
                'routingprefixlistentry',
                'routingprefixlistentry_edit',
                'routingprefixlistentry_delete',
                'routingprefixlistentry_changelog',
                'routingprefixlistentry_journal',
                'routemap_list',
                'routemap_add',
