...
urlpatterns = [
    ...
    path('ospf/instance/import/', views.OSPFInstanceBulkImportView.as_view(), name='ospfinstance_import'),
    ...
    path('ospf/area/import/', views.OSPFAreaBulkImportView.as_view(), name='ospfarea_import'),
    ...
    path('ospf/interface/import/', views.OSPFInterfaceBulkImportView.as_view(), name='ospfinterface_import'),
    ...
    path('eigrp/router/import/', views.EIGRPRouterBulkImportView.as_view(), name='eigrprouter_import'),
    ...
    path('eigrp/address-family/import/', views.EIGRPAddressFamilyBulkImportView.as_view(), name='eigrpaddressfamily_import'),
    ...
    path('eigrp/network/import/', views.EIGRPNetworkBulkImportView.as_view(), name='eigrpnetwork_import'),
    ...
    path('eigrp/interface/import/', views.EIGRPInterfaceBulkImportView.as_view(), name='eigrpinterface_import'),
