...
@register_model_view(EIGRPRouter, name='bulk_import')
...
@register_model_view(EIGRPAddressFamily, name='bulk_import')
...
@register_model_view(EIGRPInterface, name='bulk_import')
